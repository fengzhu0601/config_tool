...
class CodeGenGolangDS(object):

    def __init__(self):
        pass
    
    def genServerGolangDS(self, parser, templatePath, outputPath):
        g = GenServerGolangDS(parser, templatePath, outputPath)
        return g.gen()
    
        
class GenServerGolangDS(object):
    ...
    def genPt(self):
        ...
        pb_name = "pb_ds_"+self.parser.modName
        ...
        c = tpl.substitute(
            ...
            recvMsgRegist    = self.genMessageRegist(self.parser.requests,"Req","DSReqRegist","CS"),
            sendMsgRegist    = self.genMessageRegist(self.parser.responses,"Rep","DSRepRegist","SC")
            )

        subPath = self.outputPath + "/proto/ds/" + package_name
    ...
    def genRegistFuns(self,structList):
        ...
        for struct in structList:
            ...
            codeStr += template.substitute(
                ...
                fun = "onDs"+common.CamelCase(struct.name)
                )
        return codeStr
